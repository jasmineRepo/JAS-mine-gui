...
/**
 * A ScatterplotSimulationPlotterRefreshable is able to trace one or more pairs of data sources 
...
public class ScatterplotSimulationPlotterRefreshable extends JInternalFrame implements EventListener {
	 ...
	 * 
	 */
	public ScatterplotSimulationPlotterRefreshable(String title, String xaxis, String yaxis) {		//Includes legend by default and will accumulate data samples by default (if wanting only the most recent data points, use the other constructor)
	 ...
	 */
	public ScatterplotSimulationPlotterRefreshable(String title, String xaxis, String yaxis, boolean includeLegend, int maxSamples) {		//Can specify whether to include legend and how many samples (updates) to display
		super();
